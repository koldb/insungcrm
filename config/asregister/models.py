...
class ASsheet(models.Model):
    ...
    cuser = models.CharField(max_length=30, verbose_name='요청자', null=True, blank=True)
    user_name = models.CharField(max_length=30, verbose_name='담당자', null=True, blank=True)
    ...
    product_name = models.CharField(max_length=100, verbose_name='제품 이름', null=True, blank=True)
    la_category = models.CharField(max_length=100, verbose_name='대분류', null=True, blank=True)
    me_category = models.CharField(max_length=100, verbose_name='중분류', null=True, blank=True)
    sm_category = models.CharField(max_length=100, verbose_name='소분류', null=True, blank=True)
    asaction = models.CharField(max_length=100, verbose_name='as처리내역', null=True, blank=True)
    serial = models.CharField(null=True, blank=True, max_length=40, verbose_name='전 시리얼')
    after_serial = models.CharField(null=True, blank=True, max_length=40, verbose_name='후 시리얼')
    site = models.CharField(null=True, blank=True, max_length=40, verbose_name='프로젝트명')
