    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rp_date', models.CharField(blank=True, max_length=50, null=True, verbose_name='마감일자')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('m_title', models.ForeignKey(db_column='m_title', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='m_title', to='isscm.main_sheet')),
            ],
            options={
                'verbose_name': '서브',
