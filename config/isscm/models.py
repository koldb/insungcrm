...
class EstimateSheet(models.Model):
    ...
    quantity = models.TextField(null=True, blank=True, default=0)
    per_price = models.DecimalField(max_digits=18, decimal_places=0, null=True, blank=True, default=0)
    total_price = models.DecimalField(max_digits=18, decimal_places=0, null=True, blank=True, default=0)
...
class Ordersheet(models.Model):
    ...
    product_name = models.CharField(max_length=100, verbose_name='제품 이름')
    quantity = models.TextField(null=True, blank=True, default=0, verbose_name='수량')
    per_price = models.DecimalField(max_digits=18, decimal_places=0, null=True, blank=True, default=0)
    total_price = models.DecimalField(max_digits=18, decimal_places=0, null=True, blank=True, default=0)
    new_old = models.CharField(max_length=25, verbose_name='구분', null=True, default='신규')
    business_number = models.IntegerField(null=True, blank=True)
